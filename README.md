...
- SFML 2.5+ (muss auf deinem System installiert sein).
...
```bash
git clone https://github.com/DeinNutzername/Pong-SFML.git
cd Pong-SFML
```
...
- AABB-Kollisionserkennung: Effiziente Abfrage zwischen Ball und Paddles.

- Vektorphysik: Mathematische Berechnung der Balltrajektorie.

- Ressourcen-Management: Zentralisiertes Laden von Fonts und Texturen.